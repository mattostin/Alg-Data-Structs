...
public class UnitTests {
    ...
    public static boolean unitTest5_2() {
        ...
        if (b.getNumberOfAccounts() != 2) {
            System.out.println("5.2 Number of accounts is not 2");
            return false;
        }
        // Create an account
        b.createAccount("C");
    ...
    public static boolean unitTest5_3() {
        ...
        b.createAccount("B");
        if (b.getNumberOfAccounts() != 2) {
            System.out.println("5.3Number of accounts is not 2");
            return false;
        }
        b.createAccount("C");
        if (b.getNumberOfAccounts() != 3) {
    ...
    public static boolean unitTest5_4() {
        ...
        b.createAccount("B");
        if (b.getNumberOfAccounts() != 2) {
            System.out.println("5.4 Number of accounts is not 2");
            return false;
        }
        b.createAccount("C");
        if (b.getNumberOfAccounts() != 3) {
    ...
    public static boolean unitTest5_5() {
        ...
        // Verify the Bank has no accounts
        int numberOfAccountsZero = b.getNumberOfAccounts();
        if (numberOfAccountsZero != 0) {
            System.out.println("Number of accounts is not 0"+" expected: 0 actual: "+numberOfAccountsZero);
            return false;
        ...
        b.createAccount("B");
        int numberOfAccounts2 = b.getNumberOfAccounts();
        if (numberOfAccounts2 != 2) {
            System.out.println("5.5 Number of accounts is not 2"+"expected: 2 actual:"+numberOfAccounts2);
            return false;
        }
        b.createAccount("C");
        if (b.getNumberOfAccounts() != 3) {
        ...
        // Close account B
        b.closeAccount(66);
        int numberOfAccounts2_1 = b.getNumberOfAccounts();
        if (numberOfAccounts2_1 != 2) {
            System.out.println("5.5 Number of accounts is not 2"+"expected: 2 actual:"+numberOfAccounts2_1);
            return false;
        }
    ...
    public static boolean unitTest5_6() {
        ...
        int numberOfAccounts2 = b.getNumberOfAccounts();
        if (numberOfAccounts2 != 2) {
            System.out.println("5.6 Number of accounts is not 2"+"expected: 2 actual:"+numberOfAccounts2);
            return false;
        }
        ...
        if (b.getNumberOfAccounts() != 2) {
            System.out.println("5.6 Number of accounts is not 2");
            return false;
        }
        ...
        if (b.getNumberOfTransactions() != 2) {
            System.out.println("5.6 Number of transactions is not 2");
            return false;
        }
